    ...
    return (
        <nav className="fixed w-full top-0 flex px-6 md:px-16 h-16 bg-background text-foreground justify-between items-center border-b-4 border-foreground z-50 transition-colors duration-300">
            ...
            <div className="flex items-center gap-2 select-none">
                <img src="/hk_logo.jpeg" alt="HK Logo" className="w-8 h-8 rounded-full border-2 border-foreground object-cover shadow-[2px_2px_0px_0px_var(--foreground)]" />
                <div className="font-mono font-black text-xl md:text-2xl border-2 border-foreground bg-card text-foreground px-2.5 py-0.5 shadow-[3px_3px_0px_0px_var(--foreground)] tracking-tighter">
                    HK_
                </div>
            </div>
